            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('videos.store') }}" enctype="multipart/form-data">
                        ...
                        <!-- Video File -->
                        <div class="mt-4">
                            <x-input-label for="video_file" :value="__('Video File (MP4, MOV, etc.)')" />
                            <x-text-input id="video_file" class="block mt-1 w-full" type="file" name="video_file" required />
                        ...
                        <!-- Description -->
                        <div class="mt-4">
                            <x-input-label for="description" :value="__('Video Description (Optional)')" />
